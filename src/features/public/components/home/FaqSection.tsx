    ...
    <section className="py-32 bg-secondary/5">
      <div className="container px-4 max-w-2xl mx-auto text-center">
        ...
        <Accordion type="single" collapsible className="space-y-4">
          {faqs.map((faq, idx) => (
            <AccordionItem key={idx} value={`faq-${idx}`} className="border border-border rounded-xl">
              <AccordionTrigger className="px-6 py-4 text-lg font-medium">{faq.question}</AccordionTrigger>
