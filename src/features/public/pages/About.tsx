...
export default function About({
  ...
  return (
    <section className="py-32 container mx-auto px-4">
      {/* Title & Description */}
      <div className="max-w-7xl mx-auto mb-14 grid gap-5 text-center md:grid-cols-2 md:text-left">
        <h1 className="text-5xl font-semibold">{title}</h1>
        <p className="text-muted-foreground">{description}</p>
      </div>

      {/* Main & Secondary Images + Breakout */}
      <div className="max-w-7xl mx-auto grid gap-7 lg:grid-cols-3">
        <img
          src={mainImage.src}
          alt={mainImage.alt}
